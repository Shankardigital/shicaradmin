...
const Customers = () => {
  ...
  const getAllCustomer = async () => {
    ...
    setCustomerexcl(_data.data.customerExcel)
  }

  const Customerearch = async e => {
    const resonse = await addData(
      "customer/search?searchQuery=" + e.target.value
    )
    var _data = resonse
    setCustomer(_data.data.customerResult)
  }
  ...
  const filterCustomer = async (e) => {
    ...
    const resonse = await addData("customer/filter", bodydata)
    var _data = resonse
    setCustomer(_data.data.customerResult)
    setshow(false)
  }
                      ...
                      <Col md="3">
                        <div className="mb-4">
                          ...
                          >
                            ...
                            <option value="make_a_call"> Make a cll </option>
