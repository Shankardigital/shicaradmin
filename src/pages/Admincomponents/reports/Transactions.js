...
const Transactions = () => {
  ...
  const getAllCustomer = async () => {
    const resonse = await addData("customer/getcustomerpayments")
    var _data = resonse
    setCustomer(_data.data.customerPayment)
  }

  const Customerearch = async (e) => {
    const resonse = await addData("customer/getcustomerpayments?searchQuery=" + e.target.value)
    var _data = resonse
    setCustomer(_data.data.customerPayment)
  }
  ...
  const filterCustomer = async (e) => {
    ...
    const resonse = await addData("customer/getcustomerpaymentsbyfilter", bodydata)
    var _data = resonse
    setCustomer(_data.data.customerPayment)
    setshow(false)
  }
    ...
    <React.Fragment>
      <div className="page-content">
        <div className="container-fluid">
          <Breadcrumbs title="CA Marketing" breadcrumbItem="Transactions" />
