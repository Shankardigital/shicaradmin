...
function Termsandconditions() {
  ...
  const changstatus = async() => {
    ...
    try {
      const resonse = await updateData("userpolicies/updatetermsandcondition", bodydata)
      var _data = resonse
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <Breadcrumbs title="Shicar" breadcrumbItem="Terms & Condition" />
          <Row>
            <Col md={12}>
              <Card>
                ...
                <CardBody>
                  <div style={{ float: "right" }}>
                    ...
                    style={{width:"70px"}}
                      ...
                      title="Edit Booking"
                      onClick={() => {
                        getpopup1(form.termsAndCondition)
                      }}
                      className="mr-5"
                      color="primary"
                      outline
