...
const Banner = () => {
  ...
  const addbenners = async e => {
    ...
    try {
      const resonse = await addData("banner/addbanner", dataArray)
      var _data = resonse
      console.log(_data)
      setFiles({ image: "" })
      setform({ name: ""})
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          ...
          <Row>
          {Roles?.bannerAdd == true || Roles?.accessAll == true ? (
            <Col md={4}>
              <Card>
    ...
    ""
            ...
            <Col md={Roles?.bannerAdd == true || Roles?.accessAll == true ? 8 : 12}>
              <Card>
                <CardBody>
                  <Row>
                    <Col md="6">
                        ...
                        <tbody>
                          {lists.map((data, key) => (
                            <tr key={key}>
                              ...
                              <td>{data.status}</td>
                              <td>
                              {Roles?.bannereEdit == true || Roles?.accessAll == true ? (
                                <Button
                                  onClick={() => {
                                    getpopup(data)
                                  }}
                                ...
                                >
                                 ...
                                 {Roles?.bannerDelete == true || Roles?.accessAll == true ? (
                                <Button
                                  onClick={() => {
                                    manageDelete(data)
                                  }}
