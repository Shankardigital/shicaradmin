...
const Roles = () => {
  ...
  const [ras, setras] = useState({
    ...
    campanyproView: false,
    campanyproAdd: false,
    campanyproEdit: false,
    campanyproDelete: false,
    productsView: false,
    productsAdd: false,
    productseEdit: false,
    ...
    holdrequest: false,
    approvedwithdraws: false,
    rejectedwithdraws: false,
    pendingrides: false,
    runningrides: false,
  ...
  const handleSubmit = async e => {
    ...
    try {
      const resonse = await addData("role/addrole", bodydata)
      var _data = resonse
      console.log(_data)
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container>
          <Breadcrumbs title="Shicar" breadcrumbItem="Add Roles" />
          <Row>
            <Col>
              <Button
